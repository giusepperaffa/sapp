...
import custom_trace as trace
from issues import Instance, IssueQueryResult
from custom_trace import TraceFrameQueryResult, TraceTuple
...
# Postprocessor Class
# ===================
class PostprocessorCls:
    help_message = "Custom class for database postprocessing"
    ...
    def __init__(
        ...
        *,
        ...
        print('--- Instance of {} created ---'.format(self.__class__.__name__))
        self.db = database
